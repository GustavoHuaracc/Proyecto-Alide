                                    ...
                                    <div class="side-menu-container">
                                        <div class="navbar-header">
                                            <a class="navbar-brand" href="#" >
                                                ...
                                                <div class="title"><h2>Alide</h2></div>
                                            </a>
                                        </div><!-- .navbar-header -->
                                        ...
                                        <div class="panel-content" style=" position: relative; float: center;">
                                            <center>
                                            <img style="height: 36px; width: 36px" src=" {{ URL::to('/') }}/resources/panel-de-control.png " class="avatar" alt="avatar" style="margin-right:10px;"></center>
